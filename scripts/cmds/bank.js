...
config: {
    name: "bank",
    version: "1.0",
    author: "Aryan Chauhan(Aesther edit)", //dont change my name
    countDown: 0,
    role: 0,
    shortDescription: {
      vi: "",
  ...
  const p = getPrefix(event.threadID);
    ...
    const lianeBank = "🏛️𝗔𝗘𝗦𝗧𝗛𝗘𝗥-𝗕𝗔𝗡𝗞🏛️"; //do not change
